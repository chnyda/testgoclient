...
// OparProfilesApiService OparProfilesApi service
type OparProfilesApiService service

type ApiOpaprofilesDropdownRequest struct {
	ctx context.Context
	ApiService *OparProfilesApiService
...
*/
func (a *OparProfilesApiService) OpaprofilesDropdown(ctx context.Context) ApiOpaprofilesDropdownRequest {
	return ApiOpaprofilesDropdownRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OparProfilesApiService) OpaprofilesDropdownExecute(r ApiOpaprofilesDropdownRequest) ([]CommonExtendedDropdownDto, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OparProfilesApiService.OpaprofilesDropdown")
	if err != nil {
