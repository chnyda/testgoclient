...
```golang
import openapi "github.com/chnyda/testgoclient"
```
...
*AwsImagesApi* | [**ImagesAwsImages**](docs/AwsImagesApi.md#imagesawsimages) | **Get** /api/v1/images/aws | Retrieve aws images
...
*DnsServerApi* | [**DnsserversDelete**](docs/DnsServerApi.md#dnsserversdelete) | **Delete** /api/v1/dnsservers/{id} | Delete dns server
...
*OparProfilesApi* | [**OpaprofilesDropdown**](docs/OparProfilesApi.md#opaprofilesdropdown) | **Get** /api/v1/opaprofiles/list | Retrieve policy profiles for organization
...
*OperationCredentialApi* | [**OpscredentialsList**](docs/OperationCredentialApi.md#opscredentialslist) | **Get** /api/v1/opscredentials/list | Retrieve all operation credentials
*OperationCredentialApi* | [**OpscredentialsListByOrganizationId**](docs/OperationCredentialApi.md#opscredentialslistbyorganizationid) | **Get** /api/v1/opscredentials | Retrieve operation credentials by organization Id
